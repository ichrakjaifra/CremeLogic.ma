...
@Component({
  ...
  styles: [`
    .produits-page { min-height: 100vh; animation: fadeIn 0.5s ease-out; }
    .product-card { 
      transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
      border: 1px solid rgba(255, 255, 255, 0.4);
      border-radius: 20px;
    }
    .product-card:hover { transform: translateY(-5px); border-color: var(--dore-clair); }
    ...
    .status-badge { position: absolute; top: 10px; right: 10px; font-size: 0.65rem; }
  `]
})
