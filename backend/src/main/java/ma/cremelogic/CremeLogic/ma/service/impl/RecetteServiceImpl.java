...
public class RecetteServiceImpl implements RecetteService {
        ...
        public RecetteResponse createRecette(RecetteRequest request) {
                ...
                log.info("Recette créée: {} ({} ingrédients)", savedRecette.getNom(),
                                savedRecette.getLignesRecette().size());
        ...
        public void deleteRecette(Long id) {
                ...
                historiqueService.enregistrerSuppression("RECETTE", id,
                                "Suppression de la recette: " + recette.getNom());
        ...
        public RecetteResponse dupliquerRecette(Long id, String nouveauNom) {
                ...
                // Historique
                historiqueService.enregistrerCreation("RECETTE", savedRecette.getId(),
                                "Duplication de la recette: " + recetteOriginale.getNom() + " -> "
                                                + savedRecette.getNom());
        ...
        public RecetteResponse ajusterPortions(Long recetteId, Integer nouvellesPortions) {
                ...
                BigDecimal ratio = BigDecimal.valueOf(nouvellesPortions)
                                .divide(BigDecimal.valueOf(anciennesPortions), 4, RoundingMode.HALF_UP);
                ...
                historiqueService.enregistrerModification("RECETTE", recetteId,
                                String.format("Ajustement portions: %d -> %d portions", anciennesPortions,
                                                nouvellesPortions));
        ...
        private RecetteResponse mapToResponse(Recette recette) {
                List<LigneRecetteResponse> lignes = recette.getLignesRecette().stream()
                                .map(ligne -> LigneRecetteResponse.builder()
                                                ...
                                                .coutIngredient(ligne.getIngredient().getPrixUnitaire() != null && ligne
                                                                .getQuantite() != null ? ligne.getIngredient()
                                                                                .getPrixUnitaire()
                ...
                return RecetteResponse.builder()
                                ...
                                .createurNom(recette.getCreateur() != null ? recette.getCreateur().getNom() + " "
                                                + recette.getCreateur().getPrenom() : null)
